...
const PrequestMasterFormComponent = ({ isBusy, errors, formData, onChange, onSave, contacts }) => {
  return (
    <div className="p-1">
      <div className="grid">
        <div className="col-12 md:col-6">
          ...
          <Calendar
            ...
            dateFormat="yy-mm-dd"
            placeholder={`Select ${t_po_master.t_po_master.transaction_date.name}`}
          />
        ...
        <div className="col-12 md:col-6">
          <label
            ...
            className="block text-900 font-medium mb-2"
          >
            {t_po_master.t_po_master.contacts_id.name} <span className="text-red-500">*</span>
          </label>
          <Dropdown
            name="contacts_id"
        ...
        <div className="col-12 md:col-6">
          ...
          <InputText
            ...
            placeholder={`Enter ${t_po_master.t_po_master.transaction_note.name}`}
          />
