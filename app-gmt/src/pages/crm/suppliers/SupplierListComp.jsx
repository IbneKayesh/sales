...
const SupplierListComp = ({ dataList, onEdit, onDelete }) => {
  ...
  const supl_name_BT = (rowData) => {
    return <ActiveRowCell text={rowData.supl_name} status={rowData.lfcl_id} />;
  };

  const supl_ownm_BT = (rowData) => {
    return (
      <div className="flex flex-column">
        <span className="text-gray-700 text-sm">
          Owner/Manager: {rowData.supl_ownm}, Mobile: {rowData.supl_mob1},
          Email: {rowData.supl_mail}
        </span>
      </div>
    );
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <Column field="supl_name" header="Name" sortable body={supl_name_BT} />
        <Column field="supl_code" header="Code" sortable />
        <Column
          field="supl_ownm"
          header="Contact"
          sortable
          body={supl_ownm_BT}
        />
        <Column field="supl_adrs" header="Address" sortable />
        <Column field="supl_vatt" header="VAT" sortable />
        <Column field="acmp_name" header="Company" sortable />
