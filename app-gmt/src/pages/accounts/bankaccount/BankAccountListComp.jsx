...
const BankAccountListComp = ({ dataList, onEdit, onDelete }) => {
  ...
  const bank_name_BT = (rowData) => {
    return <ActiveRowCell text={rowData.bank_name} status={rowData.lfcl_id} />;
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <Column field="bank_name" header="Name" sortable body={bank_name_BT} />
        <Column field="acmb_code" header="Code" sortable />
        <Column field="acmb_brch" header="Branch" sortable />
...
export default BankAccountListComp;
