...
const SubCategoryListComp = ({ dataList, onEdit, onDelete }) => {
  ...
  const itcl_name_BT = (rowData) => {
    return <ActiveRowCell text={rowData.itcl_name} status={rowData.lfcl_id} />;
  };

  const itcl_imgl_BT = (rowData) => {
    return (
      <img
        src={`${rowData.itcl_imgl || "/empty.png"}`}
        alt="img"
  ...
  return (
    <div>
      ...
      >
        ...
        <Column field="itcl_name" header="Name" sortable body={itcl_name_BT} />
        <Column field="itcl_code" header="Code" sortable />
        <Column field="itcg_name" header="Category" sortable />
        <Column field="itcl_oseq" header="Order By" sortable />
        <Column field="itcl_imgl" header="Image" body={itcl_imgl_BT} />
