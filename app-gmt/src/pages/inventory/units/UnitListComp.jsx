...
const UnitListComp = ({ dataList, onEdit, onDelete }) => {
  ...
  const unit_name_BT = (rowData) => {
    return <ActiveRowCell text={rowData.unit_name} status={rowData.lfcl_id} />;
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <Column field="unit_name" header="Name" sortable body={unit_name_BT} />
        <Column field="unit_sybl" header="Code" sortable />
