...
const BankRecComp = ({ pageAuth, dataList }) => {
  ...
  const export_columns = [
    ...
    { header: "Bank Account", accessor: "chtac_cname" },
  ...
  const dt_HT = () => (
    <div className="flex justify-content-between align-items-center">
      ...
      <div className="flex gap-2 hide-on-print">
        <CSVExport
          data={dataList}
          fileName={`bank-reconciliation-${new Date().toISOString().slice(0, 10)}`}
  ...
  return (
    <div className="bankrec-wrapper">
      <div className="bankrec-title">Bank Reconciliation</div>
      <DataTable
        value={dataList}
        paginator
        rows={25}
      ...
      >
        ...
        <Column field="chtac_cname" header="Bank Account" />
