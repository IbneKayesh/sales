...
const PaymComp = ({ formData, errors, onChange }) => {
  return (
    <div className="grid m-2">
      <div className="col-12 md:col-5">In/Ex Cost</div>
      <div className="col-12 md:col-3">
        ...
        <label className="block font-bold mb-2">Invoice Discount</label>
        <InputNumber
          name="mrrmt_invds"
      ...
      <div className="col-12 md:col-4">Payment</div>
    </div>
  );
};
