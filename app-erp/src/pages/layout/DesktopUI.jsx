  ...
  return (
    ...
    >
      ...
      <div className="lockscreen-clock-container">
        <h1 className="lockscreen-time">Web Desktop Platform</h1>
        <h2 className="lockscreen-date">React | Express | PostgreSQL</h2>
      </div>
      ...
      {contextMenu && (
        ...
        >
          ...
          <button className="context-menu-item" onClick={null}>
            <span>📁</span>
