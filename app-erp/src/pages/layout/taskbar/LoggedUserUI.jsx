    ...
    <>
      ...
      <div className="profile-flyout acrylic-container">
        <div className="profile-header">
          <div className="profile-avatar-large">{user.avatarText || user.name.slice(0, 2).toUpperCase()}</div>
        ...
        <div className="profile-body">
          <button className="profile-item-btn" onClick={() => alert('Profile settings are under development!')}>
            ⚙️ Profile Settings
          </button>
          
          <button className="profile-item-btn">
            🎨 Accent Color
          </button>
          ...
          <div className="accent-selector">
            {accentOptions.map(accent => (
              <button
                ...
                title={accent.name}
              >
                <span className="accent-swatch" style={{ backgroundColor: accent.color }} />
