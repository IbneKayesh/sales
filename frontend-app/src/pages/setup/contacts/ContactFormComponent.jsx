  ...
  return (
    <div className="grid p-1">
      <div className="col-12 md:col-8">
        ...
        >
          {t_contacts.contact_name.name} <span className="text-red-500">*</span>
        </label>
        <InputText
          name="contact_name"
      ...
      <div className="col-12 md:col-2">
        ...
        {errors.contact_mobile && (
          <small className="mb-3 text-red-500">{errors.contact_mobile}</small>
        )}
      </div>
      <div className="col-12 md:col-2">
        <label
      ...
      <div className="col-12 md:col-2">
        <label
          ...
          className="block text-900 font-medium mb-2"
        >
          {t_contacts.contact_type.name} <span className="text-red-500">*</span>
        </label>
        <Dropdown
          name="contact_type"
      ...
      <div className="col-12 md:col-2">
        <label
          ...
          className="block text-900 font-medium mb-2"
        >
          {t_contacts.credit_limit.name} <span className="text-red-500">*</span>
        </label>

        <InputNumber
          name="credit_limit"
          value={formData.credit_limit}
          onChange={(e) => onChange("credit_limit", e.value)}
          className={`flex-1 ${errors.credit_limit ? "p-invalid" : ""}`}
