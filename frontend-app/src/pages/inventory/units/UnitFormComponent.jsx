  ...
  return (
    <div className="grid">
      <div className="col-12">
        <label htmlFor="unit_name" className="block text-900 font-medium mb-2">
          {t_units.unit_name.name} <span className="text-red-500">*</span>
        </label>
        <InputText
          name="unit_name"
          ...
          placeholder={`Enter ${t_units.unit_name.name}`}
        />
        {errors.unit_name && (
