    ...
    <div className="grid">
      <div className="col-12 md:col-4">
        ...
        <InputText
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_bankn.label}`}
        />
        {errors.bacts_bankn && (
      ...
      <div className="col-12 md:col-6">
        <label htmlFor="bacts_brnch" className="block font-bold mb-2">
          {tmtb_bacts.bacts_brnch.label}
        </label>
        <InputText
          name="bacts_brnch"
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_brnch.label}`}
        />
        {errors.bacts_brnch && (
      ...
      <div className="col-12 md:col-2">
        <label htmlFor="bacts_routn" className="block font-bold mb-2">
          {tmtb_bacts.bacts_routn.label}
        </label>
        <InputText
          name="bacts_routn"
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_routn.label}`}
        />
        {errors.bacts_routn && (
      ...
      <div className="col-12 md:col-4">
        <label htmlFor="bacts_acnam" className="block font-bold mb-2">
          {tmtb_bacts.bacts_acnam.label}
        </label>
        <InputText
          name="bacts_acnam"
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_acnam.label}`}
        />
        {errors.bacts_acnam && (
      ...
      <div className="col-12 md:col-3">
        <label htmlFor="bacts_acnum" className="block font-bold mb-2">
          {tmtb_bacts.bacts_acnum.label}
        </label>
        <InputText
          name="bacts_acnum"
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_acnum.label}`}
        />
        {errors.bacts_acnum && (
      ...
      <div className="col-12 md:col-3">
        <label htmlFor="bacts_notes" className="block font-bold mb-2">
          {tmtb_bacts.bacts_notes.label}
        </label>
        <InputText
          name="bacts_notes"
          ...
          placeholder={`Enter ${tmtb_bacts.bacts_notes.label}`}
        />
        {errors.bacts_notes && (
      ...
      <div className="col-12 md:col-2">
        <label htmlFor="bacts_opdat" className="block font-bold mb-2">
          {tmtb_bacts.bacts_opdat.label}
        </label>
        <Calendar
          name="bacts_opdat"
          value={
          ...
          dateFormat="yy-mm-dd"
          placeholder={`Select ${tmtb_bacts.bacts_opdat.label}`}
        />
        {errors.bacts_opdat && (
