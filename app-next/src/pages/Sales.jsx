...
import InvoicesView from './sales/InvoicesView';
  ...
  return (
    <div className="page-sales">
      ...
      <TabPanel
        ...
        actions={
          activeTab === 'orders' && (
            <button className="btn-primary" onClick={() => ordersViewRef.current?.openForm()}>
      ...
      >
        {activeTab === 'orders' ? (
          <OrdersView ref={ordersViewRef} orders={orders} setOrders={setOrders} viewMode={viewMode} />
        ) : (
