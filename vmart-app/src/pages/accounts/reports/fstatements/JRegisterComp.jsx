...
const JRegisterComp = ({ pageAuth, dataList }) => {
  ...
  const export_columns = [
    ...
    { header: "Reference", accessor: "mjrnl_refno" },
  ...
  const dt_HT = () => (
    <div className="flex justify-content-between align-items-center">
      ...
      <div className="flex gap-2 hide-on-print">
        <CSVExport
          data={dataList}
          fileName={`journal-register-${new Date().toISOString().slice(0, 10)}`}
  ...
  return (
    <div className="jregister-wrapper">
      <div className="jregister-title">Journal Register</div>
      <DataTable
        value={dataList}
        paginator
        rows={25}
      ...
      >
        ...
        <Column field="mjrnl_trtyp" header="Type" style={{ width: '10rem' }} />
