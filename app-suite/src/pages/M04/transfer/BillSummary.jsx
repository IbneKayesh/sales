...
const BillSummary = ({ formData = {}, readOnly, onChange = () => {} }) => {
  ...
  const summaryRows = [
    { label: "Item Amount", value: formData.trndm_tramt },
    { label: "Exclude Cost", value: formData.trndm_ecamt },
    { label: "Invoice Total", value: formData.trndm_stamt },
    { label: "Inventory", value: formData.trnsm_csamt },
  ];
