...
export default function ExamplesPage() {
      ...
      cards: [
        {
          ...
          description:
            "Create wireframes for the analytics dashboard with real-time widgets",
          labels: [{ text: "Design", color: "var(--primary)" }],
        ...
        },
        {
          ...
          labels: [{ text: "Backend", color: "var(--accent)" }],
        ...
        },
        {
          ...
          labels: [{ text: "Docs", color: "var(--info)" }],
      ...
      cards: [
        {
          ...
          description:
            "Migrate from class-based to functional data access patterns",
          labels: [{ text: "Refactor", color: "var(--warning)" }],
        ...
        },
        {
          ...
          labels: [
            { text: "UI", color: "var(--primary)" },
            { text: "Enhancement", color: "var(--success)" },
          ],
          assignees: [{ name: "Heidi" }],
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          description:
            "Add indexes and query optimization for report generation",
          labels: [{ text: "Performance", color: "var(--danger)" }],
          assignees: [{ name: "Ivan" }],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          labels: [{ text: "DevOps", color: "var(--accent)" }],
          assignees: [{ name: "Judy" }],
        },
        {
          id: "k8",
  ...
  const [textareaDesc, setTextareaDesc] = useState(
    "This is a read-only description with some pre-filled content for demonstration purposes.",
  );
  ...
  const treeData = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          label: "Phones",
          children: [
            { id: "item-3", label: "Smartphone" },
            { id: "item-4", label: "Feature Phone" },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          label: "Chairs",
          children: [
            { id: "item-5", label: "Office Chair" },
            { id: "item-6", label: "Gaming Chair" },
          ],
        },
        {
          id: "sub-4",
          label: "Desks",
          children: [
            { id: "item-7", label: "Standing Desk" },
            { id: "item-8", label: "Corner Desk" },
          ],
        },
      ],
    },
  ...
  const [sampleNotifications] = useState([
    {
      ...
      description: "Order #1024 from Acme Corp — $12,500",
      time: "2m ago",
      type: "success",
      read: false,
    },
    {
      ...
      description: "Invoice #INV-2024-089 was declined by the bank",
      time: "15m ago",
      type: "error",
      read: false,
    },
    {
      id: "3",
      title: "Inventory low",
      description: "SKU-ALUM-001 has only 12 units remaining",
      time: "1h ago",
      type: "warning",
      read: false,
    },
    {
      ...
      description: "Tracking #TRK-8842 — ETA 3 business days",
      time: "2h ago",
      type: "info",
      read: true,
    },
    {
      ...
      description: "john.doe@example.com joined your organization",
      time: "3h ago",
      type: "info",
      read: true,
    },
  ...
  const [inactiveRow] = useState({
    prods_cname: "Production Line B",
    prods_actve: false,
  });
  ...
  const simulateError = () => {
    ...
    setCardLoading(false);
    setCardError(
      "Failed to load data. The server returned a 500 error. Please try again.",
    );
  };
      ...
      <div className="examples-page__content">
        <div className="page-wrap">
          ...
          <PageCard data-section="form-inputs">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="All form input components in action"
              />
              <PageCardActions>
                <GroupButton
                  options={[
          ...
          <PageCard data-section="input-states">
            <PageCardHeader>
              <PageCardTitle
                title="Input States & Variants"
                subtitle="Error, required, dense, disabled, readOnly, and icon variants for all form inputs"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  <InputNumber
                    label="Age"
                    value={numError}
                    onChange={(e) => setNumError(e.target.value)}
                    error="Must be 0 or higher"
                    min={0}
                  />
                  <Dropdown
                    label="Category"
                    options={ddOptions}
                    value={ddErrorVal}
                    onChange={(e) => setDdErrorVal(e.target.value)}
                  ...
                  <InputCalendar
                    ...
                    value={calErrorVal}
                    name="cal-err"
                    onChange={(e) => setCalErrorVal(e.target.value)}
                ...
                >
                  ...
                  <Dropdown
                    ...
                    value={ddClearVal}
                    onChange={(e) => setDdClearVal(e.target.value)}
                    clearable
          ...
          <PageCard data-section="file-upload">
            <PageCardHeader>
              <PageCardTitle
                title="File Upload"
                subtitle="Drag & drop or browse files with preview"
              />
            </PageCardHeader>
            <PageCardBody>
              <FileUpload
          ...
          <PageCard data-section="input-time">
            <PageCardHeader>
              <PageCardTitle
                title="Input Time"
                subtitle="Time picker with clock icon, error, required, dense, and disabled states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
          ...
          <PageCard data-section="chip">
            <PageCardHeader>
              <PageCardTitle
                title="Chip"
                subtitle="Entities represented with icons, avatars, labels, and removable chips — multiple variants and sizes"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    <Chip variant="primary" icon={<IconUsers size={14} />}>
                      Team
                    </Chip>
                    <Chip variant="success" icon={<IconCheck size={14} />}>
                      Verified
                    </Chip>
                    <Chip
                      variant="primary"
                    ...
                    <Chip variant="warning" icon={<IconWarning size={14} />}>
                      Pending
                    </Chip>
                  </div>
                </div>
          ...
          <PageCard data-section="input-slider">
            <PageCardHeader>
              <PageCardTitle
                title="Input Slider"
                subtitle="Range slider with value display, customizable min/max/step, and error/disabled states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  <InputSlider
                    label="Decimal Step"
                    value={sliderDecimal}
                    onChange={(e) => setSliderDecimal(Number(e.target.value))}
                    min={0}
                    max={10}
                    step={0.5}
                  />
          ...
          <PageCard data-section="input-rating">
            <PageCardHeader>
              <PageCardTitle
                title="Input Rating"
                subtitle="Star rating with half-star precision, customizable min/max range, and error/disabled states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
          ...
          <PageCard data-section="input-textarea">
            <PageCardHeader>
              <PageCardTitle
                title="Text Area"
                subtitle="Multi-line text input with rows, maxLength, error, disabled, readOnly, and dense states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  <InputTextArea
                    label="With Error"
                    value="Invalid content that exceeds the expected format"
          ...
          <PageCard data-section="input-color">
            <PageCardHeader>
              <PageCardTitle
                title="Color Picker"
                subtitle="Native color input with swatch preview, hex display, error, and disabled states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
          ...
          <PageCard data-section="input-switch">
            <PageCardHeader>
              <PageCardTitle
                title="Switch"
                subtitle="Toggle switches for boolean settings with label, disabled, and dense variants"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  <InputSwitch
                    ...
                    checked={switchNotif}
                    onChange={(e) => setSwitchNotif(e.target.checked)}
                  />
                  <InputSwitch
                    label="Dark Mode"
                    checked={switchDark}
                    onChange={(e) => setSwitchDark(e.target.checked)}
                  />
                  <InputSwitch
                    label="Email Alerts"
                    checked={switchEmail}
          ...
          <PageCard data-section="datatable">
            <PageCardHeader>
              <PageCardTitle
                title="Data Table"
                subtitle="Searchable, sortable, exportable table with striped rows"
              />
            </PageCardHeader>
            <PageCardBody>
              <DataTable
          ...
          <PageCard data-section="badges">
            <PageCardHeader>
              <PageCardTitle
                title="Badge & Type-Badge Variants"
                subtitle="All badge variants — dots, icons, type badges, and edge cases"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    ...
                    <Badge variant="warning" icon={<IconWarning size={12} />}>
                      Pending
                    </Badge>
                    <Badge variant="danger" icon={<IconClose size={12} />}>
                      Failed
                    </Badge>
                    <Badge variant="muted" icon={<IconInfo size={12} />}>
                      Draft
                    </Badge>
                  </div>
                </div>
              ...
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    <Badge variant="success" dot icon={<IconCheck size={12} />}>
                      Both
                    </Badge>
                    <Badge
                      variant="warning"
                    ...
                    <Badge variant="danger" dot icon={<IconClose size={12} />}>
                      Both
                    </Badge>
                  </div>
                  <div
                ...
                >
                  ...
                  >
                    Status:{" "}
                    <Badge variant="success" icon={<IconCheck size={10} />}>
                      Active
                    </Badge>{" "}
                    &middot; Role:{" "}
                    <Badge variant="info" dot>
          ...
          <PageCard data-section="progress">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Determinate and indeterminate progress bars for loading states and API calls"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  <Progress
                    ...
                    label="Small"
                    value={33}
                    description="Compact for inline use"
                  />
                  <Progress
                    size="md"
                    label="Medium"
                    value={55}
                    description="Default size for forms and cards"
                  />
                  <Progress
                    size="lg"
                    label="Large"
                    value={77}
                    description="Prominent for full-page loading"
                  />
                </div>
                <div
                  className="col-span-6"
                ...
                >
                  ...
                  <Progress
                    ...
                    description="Request in progress — no progress known"
                  />
                  <Progress
                    indeterminate
                    size="md"
                ...
                >
                  ...
                  <Progress
                    ...
                    description="Softer visual — full bar pulses opacity"
                  />
                  <Progress
                    pulse
                    size="md"
                  ...
                  <Progress
                    pulse
                    size="lg"
                    label="Running background job"
                    variant="warning"
                    description="Pulse variant is gentler on the eyes"
                  />
                </div>
                <div
                  className="col-span-6"
                ...
                >
                  ...
                  <Progress
                    ...
                    value={100}
                    showValue={false}
                    description="showValue disabled, value at 100%"
                  />
                  <Progress label="Zero percent" value={0} variant="warning" />
                  <Progress
                    label="Hidden value text"
                    value={50}
                    showValue={false}
                  />
                </div>
          ...
          <PageCard data-section="stat-list">
            <PageCardHeader>
              <PageCardTitle
                title="Stat List Items"
                subtitle="Label, value, sub-text, and colored dot indicator"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
          ...
          <PageCard data-section="audit-data">
            <PageCardHeader>
              <PageCardTitle
                title="Audit Data"
                subtitle="Audit trail row showing active status, created by/date, updated by/date, and revision number"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
              ...
              >
                ...
                >
                  Columns: Status | Created By | Created Date | Updated By |
                  Updated Date | Revision
                </div>
              </div>
            </PageCardBody>
          </PageCard>
          ...
          <PageCard data-section="tree-view">
            <PageCardHeader>
              <PageCardTitle
                title="Tree View"
                subtitle="Checkbox tree with expand/collapse, indeterminate parent states, and nested hierarchy"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    {treeChecked.length > 0 ? (
                      <span>
                        {treeChecked.length} item
                        {treeChecked.length !== 1 ? "s" : ""} selected:{" "}
                      ...
                      <span style={{ color: "var(--text-muted)" }}>
                        Click checkboxes above to select items
                      </span>
                    )}
                  </div>
                </div>
          ...
          <PageCard data-section="carousel">
            <PageCardHeader>
              <PageCardTitle
                title="Carousel"
                subtitle="Auto-rotating slideshow with arrow navigation, dot indicators, and swipe/keyboard support"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
                    ...
                    slides={[
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--primary">
                            <span className="carousel-slide-card__icon">
                              <IconChart size={24} />
                            </span>
                            <h3 className="carousel-slide-card__title">
                              Revenue Analytics
                            </h3>
                            <p className="carousel-slide-card__desc">
                      ...
                      },
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--success">
                            ...
                            <p className="carousel-slide-card__desc">
                              Manage team members, roles, permissions, and
                      ...
                      },
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--warning">
                            ...
                            <p className="carousel-slide-card__desc">
                              Track stock levels, manage suppliers, and optimize
                              your supply chain.
                            </p>
                          </div>
                        ),
                      ...
                      },
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--danger">
                            ...
                            <p className="carousel-slide-card__desc">
                              Monitor uptime, response times, and infrastructure
                              performance metrics.
                            </p>
                          </div>
                        ),
                    ...
                    slides={[
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--accent">
                            ...
                            <p className="carousel-slide-card__desc">
                              Monthly growth analytics with year-over-year
                              comparisons.
                            </p>
                          </div>
                        ),
                      ...
                      },
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--primary">
                            ...
                            <p className="carousel-slide-card__desc">
                              Highlight your best-selling products and
                      ...
                      },
                      {
                        content: (
                          <div className="carousel-slide-card carousel-slide-card--success">
                            ...
                            <p className="carousel-slide-card__desc">
                              Track quarterly OKRs, milestones, and team
                              accomplishments.
                            </p>
                          </div>
                        ),
          ...
          <PageCard data-section="image-gallery">
            <PageCardHeader>
              <PageCardTitle
                title="Image Gallery"
                subtitle="Responsive grid with lightbox preview — click any item to open full view with navigation"
              />
            </PageCardHeader>
            <PageCardBody>
              <ImageGallery
                ...
                items={[
                  {
                    icon: (
                      <span
                        className="image-gallery__thumb-icon"
                        style={{
          ...
          <PageCard data-section="accordion-card">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Collapsible sections with single/multi-expand, disabled items, and keep-mounted content"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                    ...
                    items={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Configure system preferences, language, and regional
                      ...
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Manage email, push, and in-app notification
                    ...
                    items={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Sign up for an account, verify your email, and
                      ...
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Billing cycles, invoicing, and payment methods —
                      ...
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Connect with third-party tools using our API and
          ...
          <PageCard data-section="buttons">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="All button variants and size options"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
          ...
          <PageCard data-section="action-buttons">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Row action buttons for Edit, Activate, and Deactivate — shown conditionally based on active state"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    ...
                    <ActionButton
                      ...
                      onDelete={(row) =>
                        toast.warning(`${row.prods_cname} deactivated`)
                      }
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <ActionButton
                      ...
                      onEdit={(row) => toast.info(`Editing ${row.prods_cname}`)}
                      onDelete={(row) =>
                        toast.success(`${row.prods_cname} activated`)
                      }
                    />
                  </div>
                </div>
          ...
          <PageCard data-section="pagecard-footer">
            <PageCardHeader>
              <PageCardTitle
                title="PageCard With Footer"
                subtitle="A complete PageCard with Header, Body, and Footer — footer typically holds actions"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
              ...
              >
                ...
                >
                  The <code>PageCardFooter</code> component provides a bottom
                  section for action buttons, usually Cancel on the left and
          ...
          <PageCard data-section="tab-page">
            <PageCardHeader>
              <PageCardTitle
                title="Tab Page"
                subtitle="Underline, pills, and buttons variants with badges and icons"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
                    ...
                    tabs={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Overview content — general account information and
                            quick stats.
                          </div>
                        ),
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Settings panel — configure preferences and
                            notifications.
                          </div>
                        ),
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Billing section — invoices, payment methods, and
                            plans.
                          </div>
                        ),
                      },
                    ...
                    tabs={[
                      {
                        ...
                        content: (
                          ...
                          >
                            User management — add, edit, and deactivate team
                            members.
                          </div>
                        ),
                      },
                      ...
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Activity log — track changes and user actions.
                          </div>
                        ),
                      },
                    ]}
                    ...
                    tabs={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Detailed view with comprehensive data and metadata.
                          </div>
                        ),
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Attachments — uploaded files, documents, and images.
                          </div>
                        ),
                      },
                    ]}
          ...
          <PageCard data-section="step-page">
            <PageCardHeader>
              <PageCardTitle
                title="Step Page"
                subtitle="Horizontal and vertical step wizards with navigation controls and completion states"
              />
            </PageCardHeader>
            <PageCardBody>
              <div
                    ...
                    steps={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Enter your email and create a password for your
                            account.
                          </div>
                        ),
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Fill in your name, avatar, and contact information.
                          </div>
                        ),
                      },
                      {
                    ...
                    steps={[
                      {
                        ...
                        content: (
                          ...
                          >
                            Upload your source code, images, and assets.
                          </div>
                        ),
                      },
                      {
                        ...
                        content: (
                          ...
                          >
                            Select your build configuration, environment, and
                            target platform.
                          </div>
                        ),
                      },
          ...
          <PageCard data-section="breadcrumb">
            <PageCardHeader>
              <PageCardTitle
                title="Breadcrumb"
                subtitle="Navigation breadcrumbs with home icon, custom separators, and active page indicator"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
          ...
          <PageCard data-section="overlays">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Modal, SidePanel, and Confirm dialogs"
              />
              <PageCardActions>
                <Button
                  size="sm"
            ...
            <PageCardBody>
              <p style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                Click the buttons above to open each overlay component. The
                Modal slides in centered with a backdrop blur. The SidePanel
                slides in from the left or right edge. The Confirm dialog is a
          ...
          <PageCard data-section="standalone-confirm-section">
            <PageCardHeader>
              <PageCardTitle
                title="Confirm (Standalone)"
                subtitle="Direct Confirm component with local state — onConfirm/onCancel callbacks"
              />
              <PageCardActions>
                <Button
                  size="sm"
            ...
            <PageCardBody>
              ...
              >
                <p style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                  Unlike the global confirm from <code>useUI()</code>, this uses
                  the <code>Confirm</code> component directly with local{" "}
                  <code>open</code> state and <code>onConfirm</code> /{" "}
                  <code>onCancel</code> callbacks.
                </p>
                {confirmResult !== null && (
                  <div
                    style={{
          ...
          <PageCard data-section="save-overlay">
            <PageCardHeader>
              <PageCardTitle
                title="Save with Overlay"
                subtitle="Click Save to see a full overlay popup — simulates a 2s API call"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid">
          ...
          <PageCard data-section="notification-bell">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Dropdown notification panel with unread badge, type icons, timestamps, and mark-all-read"
              />
              <PageCardActions>
                <Button
                  size="sm"
            ...
            <PageCardBody>
              ...
              >
                ...
                >
                  ...
                  Notifications with a blue dot are unread. Click a notification
                  to mark it as read. Use "Mark all as read" to clear all unread
                  badges. The bell shows an unread count badge — up to 99+.
                </p>
            ...
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    Show a single-button modal that waits for user
                    acknowledgment.
                  </p>
                  <div
                    style={{
                ...
                >
                  ...
                  <p
                    ...
                    style={{ margin: 0, color: "var(--text-muted)" }}
                  >
                    Set <code>isBusy</code> to block UI interactions during
                    critical operations.
                  </p>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className="small"
                        style={{
                          color: isBusy ? "var(--warning)" : "var(--success)",
                        }}
                      >
                        {isBusy
                          ? "UI is currently blocked"
                          : "UI is free to interact"}
                      </span>
                    </div>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            toast.success(
                              "Operation completed! Use setIsBusy(false) to release the UI.",
                            );
                          } finally {
                            setIsBusy(false);
                          }
          ...
          <PageCard data-section="kanban-board">
            <PageCardHeader>
              <PageCardTitle
                title="Kanban Board"
                subtitle="Drag-and-drop task board with columns, cards, labels, assignee avatars, and animations"
              />
            </PageCardHeader>
            <PageCardBody>
          ...
          <PageCard data-section="drawer">
            <PageCardHeader>
              <PageCardTitle
                title="Drawer"
                subtitle="Slide-in navigation overlay with groups, items, badges, and active/disabled states"
              />
              <PageCardActions>
                <Button
                  size="sm"
            ...
            <PageCardBody>
              ...
              >
                ...
                >
                  Click "Open Drawer" to see the slide-in navigation overlay.
                  The drawer includes collapsible groups, navigation items with
                  icons, active page indicators, badges, and a close button.
          ...
          <PageCard data-section="toast-box">
            <PageCardHeader>
              <PageCardTitle
                ...
                subtitle="Trigger toast messages — success, error, info, and warning variants with auto-dismiss"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      toast.success(
                        "User account created. Welcome to the platform!",
                        { duration: 5000 },
                      )
                    }
                  >
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      toast.warning(
                        "Low disk space — only 2GB remaining. Please clean up old files.",
                        { duration: 6000 },
                      )
                    }
                  >
          ...
          <PageCard data-section="error-boundary">
            <PageCardHeader>
              <PageCardTitle
                title="Error Boundary & Empty States"
                subtitle="ErrorBoundary catches render errors; EmptyState shows contextual placeholder UI"
              />
            </PageCardHeader>
            <PageCardBody>
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                  ...
                  <EmptyState
                    ...
                    action={
                      <Button
                        size="xs"
                        variant="primary"
                        onClick={() => toast.info("Create new record")}
                      >
                        Create New
                      </Button>
                    }
                  ...
                  <EmptyState
                    ...
                    action={
                      <Button
                        size="xs"
                        variant="outline"
                        onClick={() => toast.info("Clearing filters")}
                      >
                        Clear Filters
                      </Button>
                    }
                ...
                >
                  ...
                  >
                    ...
                    <EmptyState
                      ...
                      message="The system will be down for 2 hours tonight."
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="grid" style={{ gap: "var(--sp-5)" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Wrap any component with &lt;ErrorBoundary&gt; to catch
                  ...
                  <ErrorBoundary
                    fallback={({ retry }) => (
                      ...
                      >
                        ...
                        <Button size="xs" variant="primary" onClick={retry}>
                          Retry
                        </Button>
                      </div>
                    )}
