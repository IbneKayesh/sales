...
const ProfilePage = () => {
  ...
  const PwToggle = ({ field }) => (
    <button
      ...
      tabIndex={-1}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className={styles.pwToggleIcon}>
        {showPw[field] ? (
          <>
        ...
        <div className={styles.avatarColumn}>
          <div className={styles.avatarWrap}>
            ...
            <button className={styles.avatarOverlay} onClick={() => fileInputRef.current?.click()} title="Change avatar">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className={styles.cameraIcon}>
          ...
          <div className={styles.section}>
            ...
            >
              {saving ? (
                ...
                <><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={styles.saveIcon}>
