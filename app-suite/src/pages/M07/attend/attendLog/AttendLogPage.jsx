...
import useAttendLog from "@/hooks/M07/useAttendLog";
import AttendLogList from "./AttendLogList";
import AttendLogForm from "./AttendLogForm";
    ...
    <div className="page-wrap">
      <PageCard>
        <PageCardHeader>
          <PageCardTitle
            title="Attend Logs"
            subtitle={`${listData.length} Attend Logs`}
          />
          <PageCardActions>
            {pgView === "SYS_VW_LST_1" && (
