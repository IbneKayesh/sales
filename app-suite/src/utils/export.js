 ...
 */
export function printReport(title = "Financial Report") {
  // Set the print title
  document.title = title;

  // Add title to the report print area for CSS to use
  const printArea = document.querySelector(".report-print-area");
  if (printArea) {
    const existingAttr = printArea.getAttribute("data-report-title");
  ...
  // Cleanup - remove the data attribute
