...
export default function DigitalClock({ noBackdrop = false }) {
    ...
    <div className="watch-home-container">
      ...
      <div className="watch-clock-wrapper" ref={wrapperRef}>
        <svg className="watch-clock-svg" viewBox="0 0 450 800" preserveAspectRatio="xMinYMid meet">
          <rect x="0" y="370" width="450" height="60" className={`watch-highlight-window${noBackdrop ? " watch-highlight-window--no-backdrop" : ""}`} />
