...
router.post("/create", async (req, res) => {
  try {
    ...
    const scripts = [];
    scripts.push({
      sql: `INSERT INTO tmeb_mrcpt(id, mrcpt_users, mrcpt_bsins, mrcpt_cntct, mrcpt_trnno, mrcpt_trdat,
    ...
    for (const det of tmeb_crcpt) {
      scripts.push({
        sql: `INSERT INTO tmeb_crcpt(id, crcpt_mrcpt, crcpt_bitem, crcpt_items, crcpt_itrat, crcpt_itqty,
...
router.post("/update", async (req, res) => {
  try {
    ...
    const scripts_del = [];
    scripts_del.push({
      sql: `DELETE FROM tmeb_crcpt WHERE crcpt_mrcpt = ?`,
      params: [id],
