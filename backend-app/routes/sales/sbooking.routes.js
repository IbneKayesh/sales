...
router.post("/create", async (req, res) => {
  try {
    ...
    const scripts = [];
    scripts.push({
      sql: `INSERT INTO tmeb_mbkng(id, mbkng_users, mbkng_bsins, mbkng_cntct, mbkng_trnno, mbkng_trdat,
    ...
    for (const det of tmeb_cbkng) {
      scripts.push({
        sql: `INSERT INTO tmeb_cbkng(id, cbkng_mbkng, cbkng_bitem, cbkng_items, cbkng_itrat, cbkng_itqty,
...
router.post("/update", async (req, res) => {
  try {
    ...
    const scripts_del = [];
    scripts_del.push({
      sql: `DELETE FROM tmeb_cbkng WHERE cbkng_mbkng = ?`,
      params: [id],
    ...
    //console.log(JSON.stringify(tmeb_cbkng));
