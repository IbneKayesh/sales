CREATE TABLE tmmb_prbtc (
  ...
  prbtc_price varchar(50) NOT NULL,
  prbtc_units varchar(50) NOT NULL,

  -- custom
  prbtc_itype varchar(50) NOT NULL, --RM/PM
  prbtc_group varchar(50) NOT NULL, --MAIN,CO,BY
  prbtc_brcod varchar(50),
  prbtc_batch varchar(50),
  prbtc_srial varchar(50),
  prbtc_gdstk decimal(18,6) DEFAULT 0,
  prbtc_bdstk decimal(18,6) DEFAULT 0,
  prbtc_fgrat decimal(18,6) DEFAULT 1,
  prbtc_fgval decimal(18,6) DEFAULT 1,
