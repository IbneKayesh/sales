...
CREATE TABLE tmib_bitem (
  ...
  bitem_lprat decimal(18,6) DEFAULT 0.00,
  bitem_dprat decimal(18,6) DEFAULT 0.00,
  bitem_mcmrp decimal(18,6) DEFAULT 0.00,
  bitem_sddsp decimal(18,6) DEFAULT 0.00,
  bitem_snote VARCHAR(100),
  bitem_gstkq decimal(18,6) DEFAULT 0.00,
  bitem_bstkq decimal(18,6) DEFAULT 0.00,
  bitem_istkq decimal(18,6) DEFAULT 0.00,
  bitem_mnqty decimal(18,6) DEFAULT 1,
  bitem_mxqty decimal(18,6) DEFAULT 1,
  bitem_pbqty decimal(18,6) DEFAULT 0.00,
  bitem_sbqty decimal(18,6) DEFAULT 0.00,
  bitem_mpric decimal(18,6) DEFAULT 0.00,  
