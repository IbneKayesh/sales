...
CREATE TABLE tmib_items (
  ...
  items_prvat decimal(4,2) DEFAULT 0.00,
  items_ptvat VARCHAR(10) DEFAULT 'EXEMPT',
  items_slvat decimal(4,2) DEFAULT 0.00,
  items_stvat VARCHAR(10) DEFAULT 'EXEMPT',
  ...
  items_stadj boolean NOT NULL DEFAULT true,
