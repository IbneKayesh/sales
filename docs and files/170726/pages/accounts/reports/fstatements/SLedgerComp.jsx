...
const SLedgerComp = ({ pageAuth, dataList }) => {
  ...
  const export_columns = [
    ...
    { header: "Sub Ledger", accessor: "party_pname" },
  ...
  const dt_HT = () => (
    <div className="flex justify-content-between align-items-center">
      ...
      <div className="flex gap-2 hide-on-print">
        <CSVExport
          data={dataList}
          fileName={`sub-ledger-${new Date().toISOString().slice(0, 10)}`}
  ...
  return (
    <div className="sledger-wrapper">
      <div className="sledger-title">Sub Ledger</div>
      <DataTable
        value={dataList}
        paginator
        rows={25}
      ...
      >
        ...
        <Column field="party_pname" header="Sub Ledger" />
