...
const CashBankComp = ({ pageAuth, dataList }) => {
  ...
  const export_columns = [
    ...
    { header: "Receipt (Debit)", accessor: "djrnl_drval" },
    { header: "Payment (Credit)", accessor: "djrnl_crval" },
  ];
  ...
  const dt_HT = () => (
    <div className="flex justify-content-between align-items-center">
      ...
      <div className="flex gap-2 hide-on-print">
        <CSVExport
          data={dataList}
          fileName={`cash-book-${new Date().toISOString().slice(0, 10)}`}
  ...
  return (
    <div className="cashbank-wrapper">
      <div className="cashbank-title">Cash Book</div>
      <DataTable
        value={dataList}
        paginator
        rows={25}
      ...
      >
        ...
        <Column field="djrnl_drval" header="Receipt" body={dr_BT} style={{ width: '10rem', textAlign: 'right' }} />
        <Column field="djrnl_crval" header="Payment" body={cr_BT} style={{ width: '10rem', textAlign: 'right' }} />
      </DataTable>
    </div>
  );
};
export default CashBankComp;
