...
const ALedgerComp = ({ pageAuth, dataList }) => {
  ...
  const dt_HT = () => (
    <div className="flex justify-content-between align-items-center">
      ...
      <div className="flex gap-2 hide-on-print">
        <CSVExport
          data={dataList}
          fileName={`account-ledger-${new Date().toISOString().slice(0, 10)}`}
  ...
  return (
    <div className="aledger-wrapper">
      <div className="aledger-title">Account Ledger</div>
      <DataTable
        value={dataList}
        paginator
        rows={25}
